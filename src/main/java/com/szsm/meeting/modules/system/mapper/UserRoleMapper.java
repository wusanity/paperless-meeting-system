...
public interface UserRoleMapper extends BaseMapper<UserRole> {
    ...
    @Results({
                    ...
                    @Result(property = "user",column = "user_id",javaType = User.class,one = @One(select = "com.szsm.meeting.modules.system.mapper.UserMapper.selectUserById",fetchType= FetchType.EAGER))
            })
